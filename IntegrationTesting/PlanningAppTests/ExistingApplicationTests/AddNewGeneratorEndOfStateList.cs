...
{
    public class AddNewGeneratorEndOfStateList :  IClassFixture<AddNewGeneratorEndOfStateList_WAF<vega.Startup>>
    {
        private readonly AddNewGeneratorEndOfStateList_WAF<vega.Startup> _factory;
        public AddNewGeneratorEndOfStateList(AddNewGeneratorEndOfStateList_WAF<vega.Startup> factory)
        {
            _factory = factory;
        }
    ...
    public class AddNewGeneratorEndOfStateList_WAF<TStartup> : WebApplicationFactory<vega.Startup>
    {
