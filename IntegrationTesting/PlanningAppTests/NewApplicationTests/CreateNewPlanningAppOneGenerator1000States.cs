...
{
    public class CreateNewPlanningAppOneGenerator1000States :  IClassFixture<CreateNewPlanningAppOneGenerator1000States_WAF<vega.Startup>>
    {
        private readonly CreateNewPlanningAppOneGenerator1000States_WAF<vega.Startup> _factory;
        public CreateNewPlanningAppOneGenerator1000States(CreateNewPlanningAppOneGenerator1000States_WAF<vega.Startup> factory)
        {
            _factory = factory;
        }
        ...
        public async Task Post_CreateNewPlanningAppOneGenerator1000States(string url)
        {
            // Arrange
            ...
            Assert.True(stateList[TestSettings.Thousand-1].isLastGeneratorState);
        } 
    }


    public class CreateNewPlanningAppOneGenerator1000States_WAF<TStartup> : WebApplicationFactory<vega.Startup>
    {
        ...
        private class ConfigureTestWebHost : AbstractConfigureWebHost
        {
            ...
            {      
                ...
                testData.CreateProjectGeneratorsStates(noOfGenerators:1, noOfStates:TestSettings.Thousand);
                db.SaveChanges(); 
            }
        }
    }
